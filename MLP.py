...
def train_model(mlp_model, X_train, X_test, y_train, y_test, epochs=20, batch_size=32):
    mlp_model.compile(optimizer=optimizers.Adam(learning_rate=0.0001),
...
# Train the model
history = train_model(mlp_model, X_train, X_test, y_train, y_test, epochs=20, batch_size=32)
